...
powershell -Command "Invoke-WebRequest -Uri 'https://github.com/piotrusdfgmfk/asius/blob/main/romperdownloader/romper-downloader.ps1' -OutFile '%APP_FOLDER%\romper-downloader.ps1'"
